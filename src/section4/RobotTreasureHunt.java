...
mini.setAngle(-90); mini.microMove(45);
	...
	private void spaceBarWasPressed() {
		...
		System.out.println("robotXLocation"+ robotXLocation);
		System.out.println("robotYLocation"+ robotYLocation);
		// 7. If robot is at same location as the little girl
		//      --make a pop-up tell the robot where to go next
		if(robotXLocation==722&&robotYLocation==400); {
